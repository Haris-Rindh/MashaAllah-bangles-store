      ...
      >
        ...
        <div className="flex items-center px-4 lg:px-10 py-3 lg:py-4">
          ...
          <div className="flex items-center gap-3 ml-auto flex-shrink-0">
            ...
            <Link to="/account" className="p-1.5 transition-colors text-swa-dark hover:opacity-60" aria-label="Account">
      ...
      <nav className={`fixed top-0 left-0 bottom-0 w-[85vw] max-w-sm bg-white z-[1004] flex flex-col transition-transform duration-500 ease-[cubic-bezier(0.77,0,0.175,1)] ${drawerOpen ? 'translate-x-0' : '-translate-x-full'}`}>
        ...
        <div className="flex-1 overflow-y-auto">
          ...
          <div className="mt-6 px-6 pb-10">
            ...
            <Link to="/cart" className="block w-full text-center border border-swa-dark text-swa-dark py-3.5 text-[10px] uppercase tracking-[.15em] font-bold hover:bg-swa-gray transition-colors mb-3" onClick={() => setDrawerOpen(false)}>Bag ({count})</Link>
            <Link to="/account" className="block w-full text-center border border-swa-dark text-swa-dark py-3.5 text-[10px] uppercase tracking-[.15em] font-bold hover:bg-swa-gray transition-colors" onClick={() => setDrawerOpen(false)}>My Account</Link>
          </div>
        </div>
      </nav>
    </>
